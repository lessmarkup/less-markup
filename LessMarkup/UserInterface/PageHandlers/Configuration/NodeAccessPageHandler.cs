...
{
    public class NodeAccessPageHandler : RecordListPageHandler<NodeAccessModel>, IPropertyCollectionManager
    {
        private readonly ISiteMapper _siteMapper;
        private long? _siteId;
        private long _nodeId;

        public NodeAccessPageHandler(IDomainModelProvider domainModelProvider, IDataCache dataCache, ISiteMapper siteMapper) : base(domainModelProvider, dataCache)
        {
