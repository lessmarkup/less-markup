...
{
    public class RecordListPageHandler<T> : AbstractPageHandler where T : class
    {
        ...
        public RecordListPageHandler(IDomainModelProvider domainModelProvider, IDataCache dataCache)
        {
